...
import NavigationControls from "@/components/summary/navigation-controls";
import ProgressBar from "@/components/summary/progress-bar";
import { parseSection } from "@/utils/summary-helpers";
import ContentSection from "@/components/summary/content-section";
...
const SummaryViewer = ({ summary }: { summary: string }) => {
  ...
  return (
    <Card className="relative px-2 h-[500px] sm:h-[600px] lg:[700px] w-full xl:w-[600px] overflow-hidden bg-linear-to-r from-background via-background/95 to-rose-500/5 backdrop-blur-lg shadow-2xl rounded-3xl border border-rose-500/10">
